          ...
          <div class="w-75 back-ground-wight border-1 p-2  p-lg-5 shadow p-3 m-auto mb-5 bg-white rounded ">
            ...
            <form method="post" action="backend/register_process.php" enctype="multipart/form-data">
              ...
              <div class="input-group mb-3">
                <span class="input-group-text back-ground" id="basic-addon1"><i class="bi bi-person-bounding-box w "></i></span>
                <input type="text" class="form-control" id="firstName" name="First_name" placeholder="firstName" aria-describedby="firstNameFeedback" required />
              ...
              <div class="input-group mb-3">
                <span class="input-group-text back-ground" id="basic-addon23"><i class="bi bi-person-bounding-box w "></i></span>
                <input type="text" class="form-control" id="lastName" name="last_name" placeholder="lastName" aria-describedby="lastNameFeedback" required />
                <div id="lastNameFeedback" class="invalid-feedback">
                  Please enter valid lastName as char only.
                </div>
              </div>
              <div class="input-group mb-3">
                <span class="input-group-text back-ground" id="basic-addon23qw"><i class="bi bi-person-bounding-box w "></i></span>
                <input type="email" name="email" class="form-control" id="email" placeholder="email" aria-describedby="emailFeedback" required />
              ...
              <div class="input-group mb-3">
                ...
                <input type="password" name="password" class="form-control" id="password" placeholder="Password" aria-describedby="passwordFeedback" required />
              ...
              <div class="input-group mb-3">
                ...
                <input type="password" class="form-control" id="confirmpassword" placeholder="confirmpassword" aria-describedby="confirmpasswordFeedback" required />
              ...
              <div class="input-group mb-3">
                ...
                <input type="file" class="form-control" id="Avatar" name="avatar" placeholder="Uplode your image" aria-describedby="AvatarFeedback" required />
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" id="Age" name="age" placeholder="Age" aria-describedby="AgeFeedback" required />
              ...
              <div class="input-group mb-3">
                ...
                <input type="number" class="form-control" id="phone" name="phone" placeholder="Phone" aria-describedby="phoneFeedback" required />
                <div id="phoneFeedback" class="invalid-feedback">
                  Mobile should start with 010 or 011 or 012 and 11 digits
                </div>
              </div>
              <input type="submit" class="btn btn-outline-success d-block w-50 m-auto my-3 " value="sign_up">
              <a class="btn btn-outline-success d-block w-50 m-auto my-3 " href="login.php" role="button">Login</a>
            </form>
          </div>
        </div>
      </div>
